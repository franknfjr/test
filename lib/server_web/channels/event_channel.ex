defmodule ServerWeb.EventChannel do
  use ServerWeb, :channel
  alias ServerWeb.UserPresence
  ...
  def push_out(topic, payload) do
    ServerWeb.Endpoint.broadcast("event:general", topic, payload)
  end
  def push_out(user_id, topic, payload) do
    ServerWeb.Endpoint.broadcast("event:general:#{user_id}", topic, payload)
  end
end
